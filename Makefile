...
# TODO Review and revise this Makefile! It was generated by
#      Plugin Builder and is designed to be within the plugin
#      folder; however, we prefer to keep our plugin folder
#      clean and keep all build support file (such as this
#      Makefile, .git/, etc.) outside the plugin folder.
...
#QGISDIR=C:\Users\ujr\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
...
default:
	...
	@echo is a much better solution.  A Python script, pb_tool provides
	@echo platform independent management of your plugins and runs anywhere.
